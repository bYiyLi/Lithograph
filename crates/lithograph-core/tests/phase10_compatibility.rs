...
use lithograph_core::storage::{
    branch_head, create_storage_schema, initialize_connection_state, initialize_root, list_tags,
};
    ...
    connection
        .execute_batch(
            "CREATE TABLE main._lithograph_meta(\
             ...
             VALUES(1, 'lithograph-format-v1', '00000000-0000-4000-8000-000000000012', 2);",
        )
        .expect("metadata");
