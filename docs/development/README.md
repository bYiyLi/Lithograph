...
- Phase 11：`done`；
- Phase 12：`done`；
- `docs/development/cypher25-compatibility.md` 保留 Phase 00–12 已执行证据；Full-text family 与 Phase 12 provider supplemental inventory 均已闭合为 `done`。SQLite-specific tokenizer binding 不改变冻结 Cypher 语言 coverage 分母。
