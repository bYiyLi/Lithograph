...
const PROCEDURES: &[ProcedureDefinition] = &[
    ...
    ProcedureDefinition {
        ...
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.branch.create(name :: STRING [, from :: STRING])",
        admin: false,
        outputs: &["name", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.branch.checkout",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.branch.checkout(name :: STRING)",
        admin: false,
        outputs: &["name", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.branch.list",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.branch.list()",
        admin: false,
        outputs: &["name", "commit", "active"],
    },
    ProcedureDefinition {
        name: "lithograph.branch.delete",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.branch.delete(name :: STRING)",
        admin: false,
        outputs: &["name", "previousCommit"],
    },
    ProcedureDefinition {
        name: "lithograph.commit.get",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.commit.get(version :: STRING)",
        admin: false,
        outputs: &[
            "commit",
            "parents",
    ...
    ProcedureDefinition {
        name: "lithograph.commit.create",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.commit.create([data :: ANY])",
        admin: false,
        outputs: &["commit"],
    },
    ProcedureDefinition {
        name: "lithograph.commit.data.set",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.commit.data.set(version :: STRING, data :: ANY)",
        admin: false,
        outputs: &["commit", "data"],
    },
    ProcedureDefinition {
        name: "lithograph.commit.data.clear",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.commit.data.clear(version :: STRING)",
        admin: false,
        outputs: &["commit"],
    },
    ProcedureDefinition {
        name: "lithograph.tag.create",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.tag.create(name :: STRING, target :: STRING)",
        admin: false,
        outputs: &["name", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.tag.list",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.tag.list()",
        admin: false,
        outputs: &["name", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.tag.move",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.tag.move(name :: STRING, target :: STRING)",
        admin: false,
        outputs: &["name", "previousCommit", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.tag.delete",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.tag.delete(name :: STRING)",
        admin: false,
        outputs: &["name", "previousCommit"],
    },
    ProcedureDefinition {
        ...
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.log([version :: STRING [, limit :: INTEGER [, cursor :: STRING]]])",
        admin: false,
        outputs: &[
            "commit",
            "parents",
    ...
    ProcedureDefinition {
        name: "lithograph.diff",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.diff(before :: STRING, after :: STRING)",
        admin: false,
        outputs: &["patch"],
    },
    ProcedureDefinition {
        name: "lithograph.patch.apply",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.patch.apply(patch :: MAP)",
        admin: false,
        outputs: &["commit"],
    },
    ProcedureDefinition {
        name: "lithograph.merge.start",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.merge.start(source :: STRING [, expectedHead :: STRING])",
        admin: false,
        outputs: &[
            "session",
            "targetBranch",
    ...
    ProcedureDefinition {
        name: "lithograph.merge.get",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.merge.get(session :: STRING)",
        admin: false,
        outputs: &[
            "session",
            "targetBranch",
    ...
    ProcedureDefinition {
        name: "lithograph.merge.list",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.merge.list([limit :: INTEGER [, cursor :: STRING]])",
        admin: false,
        outputs: &[
            "session",
            "targetBranch",
    ...
    ProcedureDefinition {
        name: "lithograph.merge.conflicts",
        description: "Lithograph versioned-state procedure.",
        mode: "READ",
        works_on_system: false,
        signature: "lithograph.merge.conflicts(session :: STRING [, limit :: INTEGER [, cursor :: STRING]])",
        admin: false,
        outputs: &[
            "session",
            "revision",
    ...
    ProcedureDefinition {
        name: "lithograph.merge.resolve",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.merge.resolve(session :: STRING, expectedRevision :: INTEGER, resolutions :: LIST<MAP>)",
        admin: false,
        outputs: &["session", "revision", "status", "unresolved"],
    },
    ProcedureDefinition {
        name: "lithograph.merge.finalize",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.merge.finalize(session :: STRING, expectedRevision :: INTEGER)",
        admin: false,
        outputs: &["status", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.merge.abort",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.merge.abort(session :: STRING, expectedRevision :: INTEGER)",
        admin: false,
        outputs: &["session"],
    },
    ProcedureDefinition {
        name: "lithograph.rebase",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.rebase(onto :: STRING [, options :: MAP])",
        admin: false,
        outputs: &["status", "commit", "rewritten", "conflicts"],
    },
    ProcedureDefinition {
        name: "lithograph.squash",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.squash(since :: STRING)",
        admin: false,
        outputs: &["from", "previousHead", "commit"],
    },
    ProcedureDefinition {
        name: "lithograph.reset",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.reset(target :: STRING)",
        admin: false,
        outputs: &["from", "to"],
    },
    ProcedureDefinition {
        name: "lithograph.revert",
        description: "Lithograph versioned-state procedure.",
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.revert(commit :: STRING [, options :: MAP])",
        admin: false,
        outputs: &["commit"],
    },
    ProcedureDefinition {
    ...
    ProcedureDefinition {
        ...
        mode: "WRITE",
        works_on_system: false,
        signature: "lithograph.gc()",
        admin: false,
        outputs: &["commits", "layers", "schemas", "checkpoints", "commitData"],
    },
];
...
pub(crate) fn is_version_procedure(name: &str) -> bool {
    name.to_ascii_lowercase().starts_with("lithograph.")
}
